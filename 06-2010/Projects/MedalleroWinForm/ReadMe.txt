========================================================================
    APLICACIÓN: Información general del proyecto MedalleroWinForm
========================================================================

AppWizard ha creado esta aplicación MedalleroWinForm.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación MedalleroWinForm.

MedalleroWinForm.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado MedalleroWinForm.pch y un archivo de 
