...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textLongIni->TextChanged += gcnew System::EventHandler(this, &Form1::textLongIni_TextChanged);
			// 
			// textLongFin
			// 
			...
			this->Imagen->Click += gcnew System::EventHandler(this, &Form1::Imagen_Click);
			// 
			// textResultados
			// 
...
void Restaura(){
			...
			this->textLongFin->Text="3000";
			this->textInc->Text="100";
			this->textRepIni->Text="10000";
			this->textRepFin->Text="10000";
...
void crearAlgoritmo(int a,CAlgoritmo * &alg,std::string &nomf){
	...
	switch ( a ){
			...
			case 0: alg = new CAlgoritmoPaises<CMedalleroTAbierta>;nomf = "Medallero_NPaises.txt";break;
			case 1: alg = new CAlgoritmoMedalleroOrdenadoPais<CMedalleroTAbierta>;nomf = "MedalleroOrdenado_NPaises.txt";break;
			case 2: alg = new CAlgoritmoDeporteNormal<CMedalleroTAbierta>;nomf = "MedalleroDeporte_DeporteAleatorio.txt";break;	
			case 3: alg = new CAlgoritmoDeporteOrdenado<CMedalleroTAbierta>;nomf = "MedalleroDeporteOrdenado_DeporteAleatorio.txt";break;	
			case 4: alg = new CAlgoritmoPaisPrimero<CMedalleroTAbierta>;nomf = "Clasif_NPaisesPrimero.txt";break;	
			case 5: alg = new CAlgoritmoPaisUltimo<CMedalleroTAbierta>;nomf = "Clasif_NPaisesUltimo.txt";break;	
			case 6: alg = new CAlgoritmoPaisAleatorio<CMedalleroTAbierta>;nomf = "Clasif_NPaisesAleatorio.txt";break;	
	}
}
...
private: System::Void Imagen_Click(System::Object^  sender, System::EventArgs^  e) {
		 }
private: System::Void textLongIni_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		 }
};
}