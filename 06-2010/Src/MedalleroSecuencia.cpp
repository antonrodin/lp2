...
CMedalleroSecuencia::~CMedalleroSecuencia () {
		...
		TInfoMedallasSec* aux;
		CPareja <CDeporte, TInfoMedallasSec* > pareja;
...
/*
	Observadores
*/
void CMedalleroSecuencia::mostrarSecuencia(TInfoMedallasSec* secuencia) {
...
void CMedalleroSecuencia::ponMedalla(int tipo, CPais pais, TInfoMedallasSec* secuencia) {
...
TInfoMedallasSec* CMedalleroSecuencia::buscaDeporte(bool& existe, CDeporte deporte) {
...
*/
void CMedalleroSecuencia::particion ( CPareja<CPais, CMedallas>  v[], int a, int b, int & p ) {
...
* Metodo auxiliar quicksort
*/
void CMedalleroSecuencia::quickSort( CPareja<CPais, CMedallas> v[], int a, int b ) {
...
void CMedalleroSecuencia::quickSort ( CPareja<CPais, CMedallas> v[], int num ) {
...
/*
void CMedalleroSecuencia::mergeSort(CPareja< CPais, CMedallas > v[], int num) {
	CPareja< CPais, CMedallas > * aux = new CPareja< CPais, CMedallas >[num];
	mergeSortAux(v, aux, 0, num-1);
	delete [] aux;
}

void CMedalleroSecuencia::mergeSortAux(CPareja< CPais, CMedallas > v[], CPareja< CPais, CMedallas > aux[],int ini, int fin) {
	if (ini < fin) {
		int med = (ini + fin) / 2;
