...
CAlgoritmoPaisUltimo::CAlgoritmoPaisUltimo() {
	this->_datos = 0;
}

std::string CAlgoritmoPaisUltimo::getDescription() {
	return "Pais Ultimo";
}
...
void CAlgoritmoPaisUltimo::SetUp(int tam) {		
...
void CAlgoritmoPaisUltimo::Execute() {	
...
void CAlgoritmoPaisUltimo::TearDown() {
